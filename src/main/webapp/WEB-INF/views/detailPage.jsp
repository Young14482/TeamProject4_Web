...
<body>
	...
	<div class="main">
		...
		<div class="container">
			<div class="info">
				...
				<div class="icon">
					<p>
						<img src="/static/image/엄지위로척.png" alt="좋아요" width="24"
							height="24" style="vertical-align: bottom;">${chooseCloth.cloth_good}</p>
					<p>
						<img src="/static/image/엄지아래로척.png" alt="좋아요" width="24"
							height="24" style="vertical-align: bottom;">${chooseCloth.cloth_bad}</p>
				</div>
			</div>
		</div>
	</div>
	...
	<p>
		...
		int minSize = (Integer) session.getAttribute("minSize");
		int maxSize = (Integer) session.getAttribute("maxSize");
		String[] sizes = {"S", "M", "L", "XL", "XXL"};
		%>
		사이즈 선택: <select name="size">
			<%
		...
		<!-- 여기에 개행 추가 -->
		총 결제 금액: ${finalTotalPrice}(${chooseCloth.cloth_price}원 + 배송비: 3500원)
	</p>
...
var userId = '<%=session.getAttribute("userId")%>';
	...
	function sessionSave() {
	    ...
	    fetch('/storeSelectedSize?selectedSize=' + selectedSize, {
	        method: 'POST',
	        headers: {
