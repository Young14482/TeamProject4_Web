...
<body>
	...
	<div class="panel-container" id="firstQ">
			...
			<div id="priceRange" class="price-range"
				...
				<div class="price-options">
					<label><input type="radio" name="price" value="7000 이하"
						data-min="0" data-max="7000" disabled> 7천원 이하</label> 
					<label><input type="radio" name="price" value="7000-14000" data-min="7000"
						data-max="14000" disabled> 7천원~1만 4천원</label> 
					<label><input type="radio" name="price" value="14000-21000" data-min="14000"
						data-max="21000" disabled> 1만 4천원~2만 1천원</label> 
					<label><input type="radio" name="price" value="21000-28000" data-min="21000"
						data-max="28000" disabled> 2만 1천원~2만 8천원</label> 
					<label><input type="radio" name="price" value="28000 이상" data-min="28000"
